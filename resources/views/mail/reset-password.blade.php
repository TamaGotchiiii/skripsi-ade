...
<!--[if mso]></td></tr></table><![endif]-->
	...
	<div style="color:#892C63;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;line-height:120%; padding-right: 20px; padding-left: 20px; padding-top: 20px; padding-bottom: 20px;">	
		<div style="font-size:12px;line-height:14px;color:#892C63;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;text-align:left;"><div style="line-height:14px; font-size:12px; text-align: left;"><span style="font-size: 24px; line-height: 28px;"><span style="line-height: 28px; font-size: 24px;">Hello, {{$user}}</span></span></div></div>	
	</div>
	<!--[if mso]></td></tr></table><![endif]-->
</div>
